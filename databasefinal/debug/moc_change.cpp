...
QT_MOC_LITERAL(1, 7, 7), // "opennew"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 21) // "on_pushButton_clicked"

    },
    "change\0opennew\0\0on_pushButton_clicked"
};
...
void change::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&change::opennew)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject change::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_change.data,
