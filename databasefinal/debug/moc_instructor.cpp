...
QT_MOC_LITERAL(3, 19, 7), // "opennew"
QT_MOC_LITERAL(4, 27, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(5, 49, 23), // "on_pushButton_7_clicked"
QT_MOC_LITERAL(6, 73, 23), // "on_pushButton_9_clicked"
QT_MOC_LITERAL(7, 97, 23), // "on_pushButton_2_clicked"
QT_MOC_LITERAL(8, 121, 24), // "on_pushButton_10_clicked"
QT_MOC_LITERAL(9, 146, 23), // "on_pushButton_3_clicked"
QT_MOC_LITERAL(10, 170, 24), // "on_pushButton_11_clicked"
QT_MOC_LITERAL(11, 195, 29), // "on_scourse_currentTextChanged"
QT_MOC_LITERAL(12, 225, 4) // "arg1"

    },
    "instructor\0logout\0\0opennew\0"
...
void instructor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (instructor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&instructor::logout)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (instructor::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&instructor::opennew)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject instructor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_instructor.data,
      qt_meta_data_instructor,  qt_static_metacall, nullptr, nullptr}
};
